...
<body class="bg-gray-300">
    <div class="font-calibri py-4 px-10 bg-white mx-auto" style="width: 150mm; height: 210mm;">
        ...
        <hr class="w-full bg-black" style="margin-top: 1pt; height: 2px">
        ...
        <main class="mt-1">
            ...
            <table class="text-left border-collapse border border-black w-full mt-3">
                <tr>
                    ...
                    <td style="width: 25%;">{{ $disposisi->surat_masuk->nomor_surat }}</td>
                ...
                <tr>
                    ...
                    <td colspan="3">{{ $disposisi->surat_masuk->perihal }}</td>
                </tr>
                <tr>
                    <td>Tgl/Nomor</td>
                    <td colspan="3">{{ $dateFormat->from($disposisi->surat_masuk->tanggal_surat) }} </td>
                </tr>
                <tr>
                    <td>Asal Surat</td>
                    <td colspan="3">{{ $disposisi->surat_masuk->asal_surat }} </td>
                </tr>
                <tr>
                    <td>Dari Unit Kerja</td>
                    <td colspan="3">{{ $disposisi->bidang->bidang }}</td>
                </tr>
                <tr>
                    <td>Dikemukakan Kepada</td>
                    <td colspan="3" style="padding-left: 4px"> Bidang {{ $disposisi->bidang->bidang }}</td>
                </tr>
                <tr>
